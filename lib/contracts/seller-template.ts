...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .header { 
    text-align: center; 
    border-bottom: 3px solid #cfa86e; 
    padding-bottom: 30px; 
    margin-bottom: 40px;
  }
  .logo { 
...
<div class="page">
  ...
  <div class="header">
    ...
    <div class="contract-title">عقد انضمام تاجر المعدات</div>
    <div class="contract-subtitle">Seller Partnership Agreement</div>
    <div style="margin-top: 12px; font-size: 12px; color: #666;">
      رقم العقد: GB-S-${Date.now().toString().slice(-8)} | 
  ...
  <div class="section">
    ...
    <div class="highlight-box">
      ...
      <p style="text-align: center; color: #666; margin-top: 8px; font-size: 13px;">
        نسبة العمولة المتفق عليها من إجمالي قيمة كل عملية بيع
      </p>
      <p style="text-align: center; color: #666; font-size: 13px;">
        Agreed commission rate on total value of each sale transaction
      </p>
    </div>
  </div>
  ...
  <div class="section">
    ...
    <div class="clause">
      <div class="clause-number">1. التزامات التاجر</div>
      <p>يلتزم التاجر بتقديم منتجات أصلية وموثقة فقط، مع ضمان دقة المعلومات المدرجة على المنصة وتوفير خدمة شحن وتوصيل موثوقة في المدد المحددة.</p>
    </div>
    
    <div class="clause">
      <div class="clause-number">2. التزامات المنصة</div>
      <p>تلتزم GearBeat بتوفير منصة بيع إلكترونية متكاملة، وتسوية المستحقات المالية للتاجر خلال 7 أيام عمل من اكتمال الطلب وتأكيده.</p>
    </div>
    
    <div class="clause">
      <div class="clause-number">3. سياسة الإرجاع والاسترداد</div>
      <p>يخضع الإرجاع لسياسة المنصة المعتمدة. يتحمل التاجر تكاليف الإرجاع في حالات العيوب أو عدم مطابقة المواصفات.</p>
    </div>
    
    <div class="clause">
      <div class="clause-number">4. السرية وحماية البيانات</div>
      <p>يلتزم كلا الطرفين بالحفاظ على سرية المعلومات التجارية والبيانات الشخصية وفقاً لأنظمة حماية البيانات في المملكة العربية السعودية.</p>
    </div>
    
    <div class="clause">
      <div class="clause-number">5. إنهاء العقد</div>
      <p>يحق لأي من الطرفين إنهاء العقد بإشعار كتابي مسبق مدته 30 يوماً، مع تسوية جميع المستحقات المالية المترتبة.</p>
    </div>

    <div class="clause">
      <div class="clause-number">6. تسوية النزاعات</div>
      <p>تخضع أي نزاعات تنشأ عن هذا العقد للقانون السعودي وتُحال للجهات القضائية المختصة في المملكة العربية السعودية.</p>
    </div>
  </div>
  ...
  <div class="signature-section">
    ...
    <div class="signature-box">
      <div class="signature-label">الطرف الثاني — التاجر</div>
      <div class="signature-space">التوقيع</div>
