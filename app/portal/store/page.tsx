      ...
      <div className="grid grid-3" style={{ marginTop: 30, gap: 25 }}>
        ...
        <div className="card">
          ...
          <div style={{ display: 'grid', gap: 12, marginTop: 20 }}>
            <Link href="/portal/store/products/new" className="btn btn-primary w-full"><T en="+ Add Product" ar="+ إضافة منتج" /></Link>
            <Link href="/portal/store/products" className="btn btn-secondary w-full"><T en="Manage Inventory" ar="إدارة المخزون" /></Link>
            <Link href="/portal/store/reviews" className="btn btn-secondary w-full"><T en="Customer Feedback" ar="آراء العملاء" /></Link>
          </div>
        </div>
        ...
        <div className="card col-span-2" style={{ padding: 0 }}>
          ...
          <div style={{ padding: 20, textAlign: 'center' }}>
             <Link href="/portal/store/orders" className="text-link" style={{ fontSize: '0.9rem' }}>
