...
import { ownerPortalLinks } from "@/lib/dashboard-links";
    ...
    <section>
      ...
      <div className="card">
        ...
        <div className="actions" style={{ marginTop: 30, display: 'flex', gap: 15 }}>
          <Link href="/portal/studio/create-studio" className="btn btn-primary">
            <T en="+ Create New Studio" ar="+ إنشاء استوديو جديد" />
          </Link>
          <Link href="/portal/studio/bookings" className="btn btn-secondary">
            <T en="View All Bookings" ar="عرض كافة الحجوزات" />
          </Link>
          <Link href="/portal/studio/reviews" className="btn btn-secondary">
      ...
      <div className="admin-detail-grid">
        <div className="card">
          ...
          <div className="actions">
            <Link href="/portal/studio/boost" className="btn">
        ...
        <div className="card">
          ...
          <div className="actions">
            <Link href="/portal/studio/commission" className="btn">
      ...
      <div className="admin-detail-grid">
        <div className="card">
          ...
          <div className="actions">
            <Link href="/portal/studio/payouts" className="btn">
        ...
        <div className="card">
          ...
          <div className="actions">
            <Link href="/portal/studio/bank" className="btn">
      ...
      <div className="admin-detail-grid">
        <div className="card">
          ...
          <div className="actions">
            <Link href="/portal/studio/create-studio" className="btn">
            ...
            <Link href="/portal/studio/availability" className="btn btn-secondary">
