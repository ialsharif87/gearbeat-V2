...
export default async function AdminSellerSettlementsPage() {
  ...
  return (
    <main style={{ padding: 32, background: '#0a0a0a', minHeight: '100vh', color: '#fff' }}>
      <h1 style={{ fontSize: '2rem', fontWeight: 900, marginBottom: 32 }}>
        <T en="Seller Settlements" ar="تسويات التجار" />
      </h1>
      ...
      <div style={{ background: '#111', padding: 60, borderRadius: 24, border: '1px solid #1e1e1e', textAlign: 'center' }}>
        ...
        <p style={{ color: '#666', maxWidth: 500, margin: '0 auto' }}>
          <T 
            en="We are working on a dedicated interface to manage and track bank transfers and final settlements for marketplace sellers." 
            ar="نحن نعمل على واجهة مخصصة لإدارة وتتبع التحويلات البنكية والتسويات النهائية لتجار المتجر." 
          />
        </p>
      </div>
    </main>
