      ...
      <div className="card-premium animate-up" style={{ border: '1px dashed rgba(212,175,55,0.3)', background: 'rgba(212,175,55,0.02)', padding: 40 }}>
        ...
        <div style={{ color: 'var(--muted)', lineHeight: 1.8, fontSize: '0.95rem' }}>
          ...
          <p style={{ marginBottom: 16 }}>
            <T
              en="GearBeat is operating as an MVP. Studio discovery, booking requests, catalog pages, and partner applications are provided on an as-is and as-available basis while the product is prepared for broader launch. Marketplace purchasing and automated payment processing are not active in the MVP."
              ar="تعمل GearBeat حاليًا كنسخة أولية. يتم تقديم اكتشاف الاستوديوهات وطلبات الحجز وصفحات الكتالوج وطلبات الشركاء على أساس كما هي وكما تتوفر أثناء تجهيز المنتج للإطلاق الأوسع. الشراء عبر المتجر ومعالجة المدفوعات التلقائية غير مفعلة في النسخة الأولية."
            />
          </p>
          ...
          <h3 style={{ color: '#fff', marginTop: 32, marginBottom: 16, fontSize: "1.25rem", fontWeight: 800 }}>
            <T en="3. Payments" ar="3. المدفوعات" />
          </h3>
          <p style={{ marginBottom: 16 }}>
            <T
              en="The current MVP does not process marketplace purchases or automated online card payments. Payment terms and any regulated payment-provider integrations will be documented before a live transaction flow is enabled."
              ar="لا تعالج النسخة الأولية الحالية مشتريات المتجر أو مدفوعات البطاقات التلقائية عبر الإنترنت. سيتم توثيق شروط الدفع وأي تكاملات مع مزودي دفع منظمين قبل تفعيل أي مسار معاملات حية."
            />
          </p>
